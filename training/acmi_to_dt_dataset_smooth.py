...
Default: 2 Hz decision rate (dt=0.5s), 2.0s horizon (H=2s)
Action (metric): [dpsi_rad, alt_sp_m, spd_sp_mps]
Obs (metric ENU): [x_e,y_n,z_u,vx_e,vy_n,vz_u,heading_rad_unwrapped,ground_speed]

Usage:
  python acmi_to_dt_dataset_smooth.py --in a.acmi b.acmi --out out.npz
"""

import argparse, zipfile, re, math, json
