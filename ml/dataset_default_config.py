...
HORIZON_STEPS        = K     # alias — used by export_artifact to populate policy.yaml::action_spec.horizon_steps
CONTROL_FREQUENCY_HZ = 1.0 / DT   # 2.0 Hz
...
OBS_FIELDS = [
    ...
    "ground_speed_mps",            # 2-D horizontal: sqrt(vx_east² + vy_north²)
]
ACT_FIELDS = ["dpsi_rad", "alt_sp_m", "spd_sp_mps"]
# dpsi_rad semantics: track-angle delta from t to t+HORIZON_STEPS (= H_SEC seconds), CW positive.
